...
export const TabList = ({ className, ...props }: any) => <Tab.List className={cn('flex gap-2', className)} {...props} />
...
export const TabPanels = ({ className, ...props }: any) => <Tab.Panels className={cn('w-full', className)} {...props} />
