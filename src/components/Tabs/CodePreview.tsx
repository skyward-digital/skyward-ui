...
import { TabGroup, TabList, TabTrigger, TabPanels, TabPanel } from '#/ui/components/Tabs'
...
export const CodePreview = ({ preview, code }: { preview: React.ReactElement; code: React.ReactElement }) => {
