...
<CodePreview client:load>
  <RadioCard client:load defaultChecked showRadio className="max-w-md flex items-start">
    <div className="text-left">
      <label htmlFor="custom-radio" className="font-bold">
        Radio Card
      </label>
      <p className="text-sm text-gray-500">Try clicking this to see the radio in action</p>
    </div>
  </RadioCard>
</CodePreview>
...
<CodePreview client:load>
  <RadioCard client:load id="custom-radio" defaultChecked={true} className="flex gap-4 max-w-md">
...
<CodePreview client:load>
  ...
  >
    <ContainerIcon className="size-6 flex-shrink-0 my-auto" />
    <div className="text-left">
      <label htmlFor="custom-radio" className="font-bold">
        Lorem ipsum
      </label>
