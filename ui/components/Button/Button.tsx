  ...
  return (
    <Component
      ...
      className={cn(
        ...
        variant === 'text' &&
          'border border-transparent justify-start text-gray-900 underline-offset-4 hover:underline focus:underline dark:text-gray-100  focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-200 focus:ring-gray-400/40',
        variant === 'destructive' &&
        ...
        // sizing
        size === 'xs' && 'gap-2 text-xs px-2 py-1',
        size === 'sm' && 'gap-2 text-sm px-3 py-1.5',
        size === 'md' && 'gap-2 px-3.5 py-1.5',
        size === 'lg' && 'gap-2 text-lg px-4 py-1.5',
        size === 'xl' && 'gap-2.5 text-xl px-5 py-2',
        size === '2xl' && 'gap-3 text-2xl px-5 py-2',
        ...
        {
          '[&>svg]:h-4 [&>svg]:w-4': ['xs', 'sm'].includes(size),
          '[&>svg]:h-5 [&>svg]:w-5': ['md', 'lg'].includes(size),
          '[&>svg]:h-6 [&>svg]:w-6': size === 'xl',
          '[&>svg]:h-7 [&>svg]:w-7': size === '2xl',
        },
